          ...
          <div className="flex items-start gap-3 sm:gap-4">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-kenya-green/10 text-kenya-green">
              ...
              >
                ...
                <path d="M3.5 20v-1.5A4.5 4.5 0 0 1 8 14h2a4.5 4.5 0 0 1 4.5 4.5V20M16 5.5a3 3 0 0 1 0 5.8M16 14h1a4 4 0 0 1 4 4v2" />
              </svg>
            </div>
            <div>
              ...
              <p className="mt-2 max-w-2xl text-xs leading-5 text-slate-500 dark:text-zinc-400 sm:text-sm">
                Manufacturers and producers registered as capable of supplying a
                given product - find who can actually fulfil a market
                opportunity.
              </p>
            </div>
          </div>
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      <h3 className="truncate text-sm font-semibold text-ktp-navy dark:text-zinc-50">
                        {e.name}
                      </h3>
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3 border-t border-slate-100 pt-3 dark:border-zinc-800">
                    <div>
                      ...
                      <p className="mt-1 text-xs font-semibold text-ktp-navy dark:text-zinc-200">
                        {e.employeesCount.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <p className="text-[10px] uppercase tracking-wide text-slate-400">
                      ...
                      <p className="mt-1 text-xs font-semibold text-ktp-navy dark:text-zinc-200">
                        {e.annualCapacity.toLocaleString()} {e.capacityUnit}
                      </p>
                    </div>
                  </div>
