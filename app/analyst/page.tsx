  ...
  const signInPrompt = (
    ...
    <div className="mx-auto flex min-h-full w-full max-w-md flex-1 flex-col items-center justify-center gap-4 px-6 py-10 text-center sm:px-10">
      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-kenya-green/10 text-kenya-green">
        <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true"><path d="M8 9h.01M12 9h.01M16 9h.01M7 19l-3 2 .8-3.2A7.5 7.5 0 0 1 4 14.5C4 10.4 7.6 7 12 7s8 3.4 8 7.5-3.6 7.5-8 7.5a9 9 0 0 1-5-.0Z" /><path d="M8 4.5C9.2 3.5 10.5 3 12 3c2.8 0 5 1.6 5 3.5" /></svg>
      </div>
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        <div className="flex items-start gap-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-kenya-green/10 text-kenya-green">
            <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true"><path d="M8 9h.01M12 9h.01M16 9h.01M7 19l-3 2 .8-3.2A7.5 7.5 0 0 1 4 14.5C4 10.4 7.6 7 12 7s8 3.4 8 7.5-3.6 7.5-8 7.5a9 9 0 0 1-5-.0Z" /></svg>
          </div>
          <div>
